...
public class CommandDiscord extends ICommand {
    private final FileConfiguration config = new ConfigUtils("discord").getConfig();

    public CommandDiscord(String name, List<String> aliases) {
        super(name, aliases);
