...
public class CommandForums extends ICommand {
    private final FileConfiguration config = new ConfigUtils("forums").getConfig();

    public CommandForums(String name, List<String> aliases) {
        super(name, aliases);
